...
function getNodeLeaglData(nodeInfoOnModel, queryCompanyName) {
    ...
    var dataType = "json";
     $.post("Access/getCompanyInfo",
        ...
        function(data,status){
            var leaglInfo = data['案件信息'];
            nodeInfoOnModel.basicInfo["成立时间"] = data.establishmentdate;
            nodeInfoOnModel.basicInfo["登记状态"] = data.registrationstatus;
            nodeInfoOnModel.basicInfo["注册资本"] = data.registeredcapital;
            nodeInfoOnModel.basicInfo["注册号"] = data.registrationno;
            ...
            // 限定挂载到司法节点上的个数
            // var leaglInfoTemp;
            // if(leaglInfo.length >= 200){
            //     leaglInfoTemp = leaglInfo.slice(0,1050);
            // }else{
            //     leaglInfoTemp = leaglInfo;
            // }
            // 将节点司法信息挂载到模型上
...
function getCompanyNewsList(key, compName){
    ...
    $.post("Access/news/getWordCloudList",
        {
            companyName: compName,
            key:key
        },
...
function getThisNews(thisNewsId){
    ...
    $.post("Access/news/getWordCloudNewsDetail",
        {
            key:thisNewsId
        },
        function(data,status){
